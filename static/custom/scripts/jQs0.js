...
rules['jQs'] = {
    ...
    */
    regExpYParse : function(params) {
        ...
        yielded.mod = this.formatVal(yielded.mod);
        ...
        this.result = function(yielded){
            var result = yielded.pcrS
                        ...
                        + (yielded.mod && yielded.mod!=''?yielded.mod:'')
                        +';'
            return result;
        };
        ...
        background : {
            ...
            */
            params : [{ 
                ...
                "ncnvrS" : function(){ return "#[A-Fa-f0-9]{6}|[A-Za-z0-9\,\. #]{1,50}"; }, 
                "uvrS" : function(){ return ""; }
            }]
        },
        color : {
        ...
        border : {
            ...
            */
            params : [{ 
                ...
                "pvcrS" : function(){ return rules.jQs.property.margin.params[0].pvcrS(); }, 
                "ncnvrS" : function(){ return "[A-Za-z0-9\,\.\_#]{1,50}|none|no"; }, 
                "uvrS" : function(){ return ""; }
            }]
        },
        outline : {
            ...
            */
            params : [{ 
                "pcrS" : function(){ return "outline|out"; },
                "pvcrS" : function(){ return rules.jQs.property.margin.params[0].pvcrS(); }, 
